stopwords = ["je", "tu", "il", "nous", "vous", "ils", "a", "abord", "absolument", "afin", "ah", "ai", "aie", "ailleurs",
             "ainsi", "ait", "allaient", "allo", "allons", "allô", "alors", "anterieur", "anterieure", "anterieures",
             "apres", "après", "as", "assez", "attendu", "au", "aucun", "aucune", "aujourd", "aujourd'hui", "aupres",
             "auquel", "aura", "auraient", "aurait", "auront", "aussi", "autre", "autrefois", "autrement", "autres",
             "autrui", "aux", "auxquelles", "auxquels", "avaient", "avais", "avait", "avant", "avec", "avoir", "avons",
             "ayant", "b", "bah", "bas", "basee", "bat", "beau", "beaucoup", "bien", "bigre", "boum", "bravo", "brrr",
             ...
             "directe", "directement", "dit", "dite", "dits", "divers", "diverse", "diverses", "dix", "dix-huit",
             "dix-neuf", "dix-sept", "dixième", "doit", "doivent", "donc", "dont", "douze", "douzième", "dring", "du",
             "duquel", "durant", "dès", "désormais", "e", "effet", "egale", "egalement", "egales", "eh", "elle",
             "elle-même", "elles", "elles-mêmes", "en", "encore", "enfin", "entre", "envers", "environ", "es", "est",
             "et", "etant", "etc", "etre", "eu", "euh", "eux", "eux-mêmes", "exactement", "excepté", "extenso",
             "exterieur", "f", "fais", "faisaient", "faisant", "fait", "façon", "feront", "fi", "flac", "floc", "font",
             "g", "gens", "h", "ha", "hein", "hem", "hep", "hi", "ho", "holà", "hop", "hormis", "hors", "hou", "houp",
             "hue", "hui", "huit", "huitième", "hum", "hurrah", "hé", "hélas", "i", "il", "ils", "importe", "j", "je",
             ...
             "moi-meme", "moi-même", "moindres", "moins", "mon", "moyennant", "multiple", "multiples", "même", "mêmes",
             "n", "na", "naturel", "naturelle", "naturelles", "ne", "neanmoins", "necessaire", "necessairement", "neuf",
             ...
             "être", "ô", "salut", "grandpy", "connais", "bonjour", "bot", "grandpybot", "lieu", "lieux", "trouve",
             "veux", "cherche", "recherche"]

control_characters = "[!*'();:@&=+$,/?%#[]"

bot_address_ok = ["Je suis un robot et j'ai trouvé l'adresse : ",
                "j'ai trouvé l'adresse : ",
                "l'adresse est: "]

bot_address_ko = ["Je n'ai rien trouvé sur google map, reformulez la recherche! ",
                "avancons dans la recherche avec une nouvelle question car il n'y a pas de map! ",
                "cette adresse semble incorrecte !"]

bot_message_wiki_ok = ["Mais t'ai-je déjà raconté l'histoire de ce quartier qui m'a vu en culottes courtes ? : ",
                    "Je vais te résumer l'histoire de ce lieu! ",
                    "Voici un résumé bref de cette adresse!"]

bot_message_wiki_ko = ["Je n'ai rien trouvé comme information sur wikipedia! ",
                    "Il n'y a pas d'information sur wikipedia!",
                    "Pas de résumé de ce lieu sur wikipedia pour cette adresse!"]